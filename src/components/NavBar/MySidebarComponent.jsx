...
export const SideBarComponent = () => {
  ...
  return (
    <div className="sidebar"> {/* Assign class for overall sidebar styling */}
      <CDBSidebar textColor="#fff" backgroundColor="#333" className="sidebar-content"> {/* Assign class for background and text color */}
        ...
        <CDBSidebarContent>
          <CDBSidebarMenu>
            ...
            <div onClick={handleLogout} style={{ cursor: 'pointer', color: 'inherit' }}>
